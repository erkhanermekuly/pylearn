...
<div class="lg:hidden flex justify-between items-center p-5 bg-white border-b sticky top-0 z-[60] shadow-sm">
    ...
    <div class="flex flex-col items-center text-center">
        ...
        <span id="mobileGroupName" class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Сабақ қосу</span>
    </div>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="premium-card overflow-hidden">
            ...
            <div class="p-6 sm:p-10 border-b border-slate-100 bg-white">
                <h1 class="text-xl sm:text-2xl font-black text-slate-800 tracking-tight">Жаңа сабақ сақтау</h1>
                <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-wider">Мұғалімнің жұмыс панелі</p>
            </div>
            ...
            <form method="POST" action="{{ route('teacher.lessons.store') }}" enctype="multipart/form-data" class="p-6 sm:p-10 space-y-8">
                ...
                <div class="space-y-5" style="margin-top: -5px;">
                    <h2 class="section-title">01. Сабақ негіздері</h2>
                    
                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-slate-700 ml-1">Сабақ тақырыбы</label>
                        <input name="lesson_title" type="text" placeholder="Тақырыпты енгізіңіз..." required 
                            class="w-full p-4 input-field font-bold text-sm text-slate-700 placeholder:text-slate-300">
                    </div>

                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-slate-700 ml-1">Сабақ мәтіні (Теория)</label>
                        <textarea name="lesson_content" rows="5" placeholder="Теориялық материалды осында жазыңыз..." required 
                ...
                <div class="space-y-5 pt-4">
                    <h2 class="section-title">02. Қосымша материалдар</h2>
                    ...
                    <div class="relative">
                        ...
                        <label for="pdf-upload" class="flex items-center justify-between w-full p-4 input-field cursor-pointer group">
                            <span id="file-label" class="text-sm font-bold text-slate-400 group-hover:text-indigo-500 transition-colors">PDF файл жүктеу...</span>
                        ...
                        <p id="file-name" class="mt-2 text-[10px] font-black text-emerald-500 uppercase px-2 hidden">✓ Файл дайын</p>
                    </div>
                </div>
                ...
                <div class="space-y-5 pt-4">
                    <div class="flex items-center gap-2">
                        <h2 class="section-title text-indigo-600">03. Үй тапсырмасы</h2>
                        <div class="h-px flex-1 bg-indigo-50"></div>
                    </div>
                    
                    <div class="grid grid-cols-1 gap-4">
                        <input name="assignment_title" type="text" placeholder="Тапсырма атауы..." required 
                            class="w-full p-4 input-field font-bold text-sm text-slate-700 placeholder:text-slate-300">
                        
                        <textarea name="assignment_description" rows="3" placeholder="Тапсырма шарты мен критерийлері..." required 
                            class="w-full p-4 input-field font-medium text-sm text-slate-600 resize-none placeholder:text-slate-300"></textarea>
                    </div>
                </div>
                ...
                <div class="pt-8">
                    ...
                    <p class="text-center mt-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Барлық деректер автоматты түрде сақталады</p>
                </div>
            </form>
        </div>
    </div>
