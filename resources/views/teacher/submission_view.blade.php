    ...
    <main class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="glass-card p-8 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div class="bg-white border-2 border-indigo-100 rounded-2xl p-4 text-center min-w-[140px]">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Ағымдағы баға</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="glass-card p-6">
                    <h3 class="font-black text-slate-800 text-sm uppercase tracking-wider mb-6 pb-2 border-b border-slate-100">💬 Пікірлер алмасу</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        @empty
                            <p class="text-center py-4 text-slate-400 text-sm italic">Әзірге пікірлер жазылмаған...</p>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="glass-card p-6 sticky top-6">
                    <h4 class="font-black text-slate-800 text-sm uppercase tracking-wider mb-6">Бағалау және Кері байланыс</h4>
                    
                    <form method="POST" action="{{ route('teacher.submission.update', $submission) }}" class="space-y-6">
                        @csrf
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Мұғалім пікірі</label>
                            <textarea name="feedback" rows="5" class="w-full p-4 bg-slate-50 border border-slate-100 rounded-xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-400 focus:outline-none transition-all text-sm font-medium" placeholder="Жұмыс бойынша ескертулер жазыңыз...">{{ old('feedback', $submission->feedback) }}</textarea>
                        </div>

                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Баға (49 - 100)</label>
                            <div class="relative">
                            ...
                            <p class="text-[10px] text-amber-500 mt-2 font-bold flex items-center gap-1">
                                ...
                                Ескерту: Баға 49-дан кем болмауы тиіс.
                            </p>
                        </div>
